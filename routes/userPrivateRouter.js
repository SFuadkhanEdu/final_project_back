...
const router = Router();
import { createUser, updateUser, deleteUser, logoutUser, getRole, updateUserSelf } from "../controllers/userController.js";
...
router.put("/users/self",verifyToken, updateUserSelf);
